                                ...
                                if (filter_var($adata, FILTER_VALIDATE_URL)) {
                                    ...
                                    if (is_file($filename)) {
                                        ...
                                        if (!$attach_id) {
                                            ...
                                            $file = \ElementorProto\Plugin::instance()->assets_manager->_wp_relative_upload_path($new_path, $filename);
                                            if ($new_path != $file) {
                            ...
                            case 'repeater':
                                ...
                                if (!empty($adata)) {
                                    ...
                                    if (Utils::is_plugin_active('advanced-custom-fields-pro')) {
                                        if (\ElementorProto\Core\Utils\Acf::set_repeater($akey, $adata, $obj_id, $type)) {
                                            $continue = true;
                                        }
                                    }
                                    if (Utils::is_plugin_active('jet-engine')) {
                                        if (\ElementorProto\Core\Utils\Jet::set_repeater($akey, $adata, $obj_id, $type)) {
                                            $continue = true;
                                        }
                                    }
                                    //var_dump($adata);
