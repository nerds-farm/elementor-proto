...
class E_Query extends Control_Select2 {
    ...
    public function enqueue() {
        wp_enqueue_style('editor-control-e-query', ELEMENTOR_PROTO_URL.'assets/css/editor-control-e-query.css');
        wp_enqueue_script('editor-control-e-query', ELEMENTOR_PROTO_URL.'assets/js/editor-control-e-query.js');
