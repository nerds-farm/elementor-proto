...
namespace ElementorProto\Core\Controls\Groups;
...
class Sourcetype extends Group_Control_Base {
    ...
    use \ElementorProto\Core\Controls\Traits\Base;
    ...
    protected function init_fields() {
        ...
        $controls['type'] = [
            'label' => esc_html__('Source', 'elementor') . '<b> ' . esc_html__('from', 'elementor') . ':</b>',
        ...
        $controls['post'] = [
            'type' => 'e-query',
            'placeholder' => esc_html__('Search Post', 'elementor'),
            'description' => esc_html__('Leave empty for Current Post', 'elementor'),
            'label_block' => true,
            'query_type' => 'posts',
            'condition' => [
                'type' => 'post'
        ...
        $controls['post_field'] = [
            'type' => 'e-query',
            'placeholder' => esc_html__('Search Post Field', 'elementor'),
            'label_block' => true,
            'query_type' => 'fields',
            'object_type' => 'post',
            'condition' => [
        ...
        $controls['term'] = [
            'type' => 'e-query',
            'placeholder' => esc_html__('Search Term', 'elementor'),
            'label_block' => true,
            'query_type' => 'terms',
            'condition' => [
                'type' => 'term'
        ...
        $controls['term_field'] = [
            'type' => 'e-query',
            'placeholder' => esc_html__('Search Term Field', 'elementor'),
            'label_block' => true,
            'query_type' => 'fields',
            'object_type' => 'term',
            'condition' => [
        ...
        $controls['user'] = [
            'type' => 'e-query',
            'placeholder' => esc_html__('Search User', 'elementor'),
            'description' => esc_html__('Leave empty for Current User', 'elementor'),
            'label_block' => true,
            'query_type' => 'users',
            'condition' => [
                'type' => 'user'
        ...
        $controls['user_field'] = [
            'type' => 'e-query',
            'placeholder' => esc_html__('Search User Field', 'elementor'),
            'label_block' => true,
            'query_type' => 'fields',
            'object_type' => 'user',
            'condition' => [
        ...
        $controls['attachment'] = [
            'type' => 'file',
            'placeholder' => esc_html__('Search Media', 'elementor'),
            'label_block' => true,
            'condition' => [
                'type' => 'attachment'
            ],
        ...
        $controls['attachment_field'] = [
            'type' => 'e-query',
            'placeholder' => esc_html__('Search Media Field', 'elementor'),
            'label_block' => true,
            'query_type' => 'fields',
        ...
        $controls['option'] = [
            'type' => 'e-query',
            'placeholder' => esc_html__('Search Site Option', 'elementor'),
            'label_block' => true,
            'query_type' => 'options',
            'condition' => [
                'type' => 'option'
        ...
        $controls['static'] = [
            ...
            'placeholder' => esc_html__('1, abc, 3', 'elementor'),
            'description' => esc_html__('Use as Static values or use as Fallback', 'elementor'),
            'label_block' => true,
                /* 'condition' => [
                  'type' => 'static'
                  ], */
