...
class Metafieldtype extends Group_Control_Base {
    ...
    protected function init_fields() {
        ...
        $controls['type'] = [
            'label' => esc_html__('Custom Field', 'elementor') . '<b> ' . esc_html__('from', 'elementor') . ':</b>',
        ...
        $controls['post'] = [
            'type' => 'e-query',
            'placeholder' => esc_html__('Search Post Custom Field', 'elementor'),
            'label_block' => true,
            'query_type' => 'metas',
            'object_type' => 'post',
            'condition' => [
        ...
        $controls['term'] = [
            'type' => 'e-query',
            'placeholder' => esc_html__('Search Term Custom Field', 'elementor'),
            'label_block' => true,
            'query_type' => 'metas',
            'object_type' => 'term',
            'condition' => [
        ...
        $controls['user'] = [
            'type' => 'e-query',
            'placeholder' => esc_html__('Search User Custom Field', 'elementor'),
            'label_block' => true,
            'query_type' => 'metas',
            'object_type' => 'user',
            'condition' => [
        ...
        $controls['attachment'] = [
            'type' => 'e-query',
            'placeholder' => esc_html__('Search Media Custom Field', 'elementor'),
            'label_block' => true,
            'query_type' => 'metas',
