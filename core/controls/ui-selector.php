...
class Ui_Selector extends Base_Data_Control {
    ...
    public function enqueue() {        
        // Style
        wp_enqueue_style('editor-control-ui-selector', ELEMENTOR_PROTO_URL.'assets/css/editor-control-ui-selector.css');
        // Scripts
        wp_enqueue_script('editor-control-ui-selector', ELEMENTOR_PROTO_URL.'assets/js/editor-control-ui-selector.js');
    }
