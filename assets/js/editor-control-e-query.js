...
window.addEventListener('load', (event) => {
    ...
    let ControlEQuery = elementor.modules.controls.Select2.extend({
        ...
        updateQueryBtn: function updateQueryBtn() {
            ...
            ethis.siblings('.elementor-control-quick-edit').remove();
            let url = '#',
            ...
            if (url != '#') {
                sel2.after('<div class="elementor-control-unit-1 elementor-control-quick-edit tooltip-target" data-tooltip="' + (obj_id ? 'Edit ' : 'Add new ') + q_type_single + '"><a href="' + url + '" target="_blank" class="quick-edit-btn"><i class="eicon-' + (obj_id ? 'pencil' : 'plus') + '"></i></a></div>');
